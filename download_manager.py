...
Télécharge les gros fichiers depuis Google Drive ou Hugging Face
"""
...
class DownloadManager:
    ...
    def __init__(self):
        ...
        self.resources = {
            "chroma_db": {
                ...
                "type": "huggingface",
                "repo_id": "cinder06/legalbot-chromadb",
    ...
    def download_from_huggingface(self, repo_id: str, local_path: Path, description: str) -> bool:
        """Télécharge depuis Hugging Face"""
        try:
            logger.info(f"📥 Téléchargement {description} depuis Hugging Face...")
            
            # Installer huggingface_hub si nécessaire
            try:
                from huggingface_hub import hf_hub_download, snapshot_download
            except ImportError:
                logger.info("📦 Installation de huggingface_hub...")
            ...
            logger.info(f"✅ {description} téléchargé avec succès")
            return True
    ...
    def download_resource(self, resource_name: str) -> bool:
        ...
        if config["type"] == "direct_download":
            ...
            repo_id = config.get("repo_id", config["url"])
